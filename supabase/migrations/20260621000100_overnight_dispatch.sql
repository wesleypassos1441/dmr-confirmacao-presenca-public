...
begin
  ...
  with base as (
    select
      ...
      ) at time zone 'America/Sao_Paulo') as entrada_em,
      ((
        case
          when ec.horario_inicio_disparo > ec.horario_inicio
            then e.data + interval '1 day' + ec.horario_inicio - interval '60 minutes'
          else e.data + ec.horario_inicio - interval '60 minutes'
        end
    ...
    where e.data = v_local_today
      ...
      and (e.data + ec.horario_inicio_disparo) < (
        case
          when ec.horario_inicio_disparo > ec.horario_inicio
            then e.data + interval '1 day' + ec.horario_inicio - interval '60 minutes'
          else e.data + ec.horario_inicio - interval '60 minutes'
